...
import IndicatorSkeleton from "../../overview/components/skeletons/IndicatorSceleton";
...
const Indicators = () => {
  ...
  const indicators = [
    ...
    },
    {
      ...
      value: data?.totalCanceledOrders ?? 0,
      type: "canceled",
    },
    {
  ...
  return (
    <div className="flex flex-wrap justify-between gap-[16px] sm:gap-[32px]">
      {indicators.map((item, idx) => (
        <div
          key={idx}
          className="pl-[24px]! p-[16px] rounded-[12px] space-y-[24px] bg-primary-b100 
            w-[calc(50%-8px)] sm:w-[calc(50%-16px)] lg:w-[calc(25%-24px)] 
            transition-all duration-200 flex flex-col justify-center h-[80px] sm:h-[120px]"
        >
          <div className="flex justify-between items-center">
            <div className="flex flex-col gap-[4px]">
              ...
              <strong className="l2-b sm:sub-h1 transition-all duration-300 ease-out">
