  ...
  return (
    <section className="py-10 md:py-24 flex flex-col justify-center items-center text-center max-w-[1232px] w-full mx-auto gap-x-[40px] md:gap-[56px] px-[20px] md:px-0 gap-[40px] min-h-screen">
      <div>
        ...
        <p className="body-1 mt-[12px] text-[12px] md:body-1 max-w-[295px] md:text-[18px] md:max-w-full text-neutral-n900">
          Find the flavor that matches your vibe today. Start your day with a
          delicious splash.
        </p>
      </div>

      <div className="md:flex justify-center w-full gap-7 mt-20 md:mt-18 h-full flex-wrap gap-y-32 grid grid-cols-2">
        <ProductCard
