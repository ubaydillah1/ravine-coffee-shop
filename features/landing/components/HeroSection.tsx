...
const HeroSection = () => {
  return (
    <section className="lg:h-screen bg-primary-b100 w-full px-[20px] md:px-[40px] pt-[90px] pb-[30px] md:pb-[0px]">
      <div className="max-w-[1232px] mx-auto flex h-full flex-col lg:flex-row justify-between">
        <div className="flex flex-col justify-between order-2 lg:order-1 text-center lg:text-left gap-[22px] sm:gap-[53px]">
          <div></div>
          ...
          <div className="flex w-full lg:max-w-[336px] lg:w-full justify-between md:justify-center md:gap-[60px] lg:justify-between lg:gap-0 text-center items-center mx-auto lg:mx-0 mt-[50px] md:mt-0 md:mb-[90px]">
